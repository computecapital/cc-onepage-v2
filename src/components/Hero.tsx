...
export function Hero() {
  ...
  const fullDescription = "Investimentos estratégicos, soluções em IA e energia sustentável. Três verticais que transformam ideias em realidade.";
      ...
      <div className="max-w-5xl mx-auto text-center z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <button className="btn-primary" style={{ cursor: 'pointer' }} onClick={handleCompanyClick}>
            <span className="font-[DM_Sans]">Conheça Nossas Empresas</span>
          ...
          <a className="btn-ghost" href="https://wa.me/5581999003360">
            <span className="font-[DM_Sans]">Entre em Contato</span>
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
